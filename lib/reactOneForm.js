...
var Input = function Input(props) {
  var _style$props = (0, _extends3.default)({ style: {} }, props),
      id = _style$props.id,
      type = _style$props.type,
      label = _style$props.label,
      values = _style$props.values,
      valuesName = _style$props.valuesName,
      store = _style$props.store,
      change = _style$props.change,
      options = _style$props.options,
      style = _style$props.style;

  var value = store.data[id];
  var err = store.err && store.err.errors && store.err.errors[id] && store.err.errors[id];
