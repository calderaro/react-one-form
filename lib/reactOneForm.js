    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          store.process ? _react2.default.createElement('i', { className: 'fa fa-circle-o-notch fa-spin' }) : 'Guardar'
        )
      )
    )
  );
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = InputFile.__proto__ || (0, _getPrototypeOf2.default)(InputFile)).call.apply(_ref, [this].concat(args))), _this), _this.open = function () {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          isFileList(value) ? [].concat((0, _toConsumableArray3.default)(value)).map(function (v) {
            return v.name;
