(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("reactOneForm", ["react"], factory);
	else if(typeof exports === 'object')
		exports["reactOneForm"] = factory(require("react"));
	else
		root["reactOneForm"] = factory(root["React"]);
...
var baseSetData = __webpack_require__(87),
    createBind = __webpack_require__(158),
    createCurry = __webpack_require__(159),
    createHybrid = __webpack_require__(92),
    createPartial = __webpack_require__(178),
    getData = __webpack_require__(96),
    mergeData = __webpack_require__(179),
    setData = __webpack_require__(98),
...
var _toPairs = __webpack_require__(146);
...
var _InputFile = __webpack_require__(273);
...
var Input = function Input(props) {
  var defaults = { style: {}, type: 'text' };
  var sprops = (0, _extends3.default)({}, defaults, props);
  var id = sprops.id,
      type = sprops.type,
      label = sprops.label,
      value = sprops.value,
      values = sprops.values,
      valuesName = sprops.valuesName,
      store = sprops.store,
      change = sprops.change,
      options = sprops.options,
      style = sprops.style;

  var val = value || (0, _get2.default)(id, store.data);
  var err = store.err && store.err[id];
  var getOptions = function getOptions(values) {
    return Array.isArray(values) ? values.map(function (e, i) {
      return _react2.default.createElement(
        'option',
        { key: i, value: e.value },
        e.label
      );
    }) : (0, _toPairs2.default)(values).map(function (e, i) {
      return _react2.default.createElement(
        'option',
        { key: i, value: e[0] },
        e[1]
  ...
  var radio = function radio() {
    return _react2.default.createElement(
      'div',
      { className: style[id] || style[type] },
      (options || store[valuesName || id + 'Options']).map(function (o, i) {
        return _react2.default.createElement(
          'div',
          { key: i },
          _react2.default.createElement(
  ...
  var file = function file() {
    return _react2.default.createElement(_InputFile2.default, { id: id, type: type, label: label, value: val, change: change, style: style, err: err });
  };
  ...
  var text = function text() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement('input', {
        ...
        value: val,
        onChange: change,
        min: undefined.props.min,
        max: undefined.props.max }),
      err ? _react2.default.createElement(
        'span',
        null,
        err
...
var baseConvert = __webpack_require__(147),
...
var identity = __webpack_require__(49),
    metaMap = __webpack_require__(88);
...
var composeArgs = __webpack_require__(93),
    composeArgsRight = __webpack_require__(94),
    countHolders = __webpack_require__(160),
    createCtor = __webpack_require__(29),
    createRecurry = __webpack_require__(95),
    getHolder = __webpack_require__(103),
...
var getWrapDetails = __webpack_require__(167),
    insertWrapDetails = __webpack_require__(168),
    setToString = __webpack_require__(101),
    updateWrapDetails = __webpack_require__(171);
...
var baseSetToString = __webpack_require__(169),
    shortOut = __webpack_require__(99);
...
var Stack = __webpack_require__(65),
    ...
    copySymbols = __webpack_require__(214),
    copySymbolsIn = __webpack_require__(216),
    ...
    isArray = __webpack_require__(1),
    isBuffer = __webpack_require__(59),
    isMap = __webpack_require__(228),
    isObject = __webpack_require__(6),
    isSet = __webpack_require__(230),
    keys = __webpack_require__(22);
...
var SetCache = __webpack_require__(241),
    arraySome = __webpack_require__(244),
    cacheHas = __webpack_require__(245);
...
var Form = function Form(_ref) {
  ...
  var go = actions.router.go;
  var store = state[model];
  var _actions$model = actions[model],
      save = _actions$model.save,
      change = _actions$model.change;

  var parseInputs = function parseInputs(inputs) {
    return inputs.map(function (input) {
      return Array.isArray(input) ? _react2.default.createElement(
        'div',
        null,
        parseInputs(input)
      ) : (0, _Input2.default)((0, _extends3.default)({ store: store, change: change }, input));
    });
  };
  return _react2.default.createElement(
    'div',
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          store.process ? _react2.default.createElement(
            'div',
            null,
...
var convert = __webpack_require__(86),
    func = convert('toPairs', __webpack_require__(267), __webpack_require__(271));

func.placeholder = __webpack_require__(47);
module.exports = func;
...
var mapping = __webpack_require__(148),
    fallbackHolder = __webpack_require__(47);
...
module.exports = {
  'ary': __webpack_require__(150),
  'assign': __webpack_require__(105),
  'clone': __webpack_require__(187),
  'curry': __webpack_require__(232),
  'forEach': __webpack_require__(54),
  'isArray': __webpack_require__(1),
  'isError': __webpack_require__(233),
  'isFunction': __webpack_require__(50),
  'isWeakMap': __webpack_require__(235),
  'iteratee': __webpack_require__(236),
  'keys': __webpack_require__(110),
  'rearg': __webpack_require__(260),
  'toInteger': __webpack_require__(104),
  'toPath': __webpack_require__(266)
};
...
var LazyWrapper = __webpack_require__(52),
    LodashWrapper = __webpack_require__(97),
    baseLodash = __webpack_require__(53),
    isArray = __webpack_require__(1),
    isObjectLike = __webpack_require__(2),
    wrapperClone = __webpack_require__(166);
...
var copyArray = __webpack_require__(31),
    isIndex = __webpack_require__(55);
...
var cloneArrayBuffer = __webpack_require__(71),
    cloneDataView = __webpack_require__(223),
    cloneRegExp = __webpack_require__(224),
    cloneSymbol = __webpack_require__(225),
    cloneTypedArray = __webpack_require__(226);
...
var baseIsSet = __webpack_require__(231),
    baseUnary = __webpack_require__(62),
    nodeUtil = __webpack_require__(63);
...
var baseProperty = __webpack_require__(258),
...
var createToPairs = __webpack_require__(268),
    keys = __webpack_require__(22);
...
var baseToPairs = __webpack_require__(269),
    getTag = __webpack_require__(18),
    mapToArray = __webpack_require__(122),
    setToPairs = __webpack_require__(270);
...
var isFileList = function isFileList(i) {
  return Object.prototype.toString.call(i) === '[object FileList]';
};

var InputFile = function (_React$Component) {
  (0, _inherits3.default)(InputFile, _React$Component);
  ...
  function InputFile() {
    ...
    (0, _classCallCheck3.default)(this, InputFile);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = InputFile.__proto__ || (0, _getPrototypeOf2.default)(InputFile)).call.apply(_ref, [this].concat(args))), _this), _this.open = function () {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', {
            type: 'text',
            value: isFileList(value) ? [].concat((0, _toConsumableArray3.default)(value)).map(function (v) {
              return v.name;
            }).join(', ') : value.name ? value.name : value }),
          _react2.default.createElement(
            'button',
            { type: 'button', onClick: _this.open },
            'Seleccionar'
          ),
          _react2.default.createElement(
            'button',
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(37)(Function.call, __webpack_require__(136).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
